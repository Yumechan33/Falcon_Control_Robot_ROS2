...
static const _FalconPos_type_support_symbol_names_t _FalconPos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, falcon_interfaces, msg, FalconPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, falcon_interfaces, msg, FalconPos)),
  }
};
...
{
  return &::falcon_interfaces::msg::rosidl_typesupport_cpp::FalconPos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, falcon_interfaces, msg, FalconPos)() {
  return get_message_type_support_handle<falcon_interfaces::msg::FalconPos>();
}
