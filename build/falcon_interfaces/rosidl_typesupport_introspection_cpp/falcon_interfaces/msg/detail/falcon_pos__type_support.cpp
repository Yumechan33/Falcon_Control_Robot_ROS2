...
{
  new (message_memory) falcon_interfaces::msg::FalconPos(_init);
}

void FalconPos_fini_function(void * message_memory)
{
  auto typed_message = static_cast<falcon_interfaces::msg::FalconPos *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FalconPos_message_member_array[3] = {
  {
    ...
    offsetof(falcon_interfaces::msg::FalconPos, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(falcon_interfaces::msg::FalconPos, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(falcon_interfaces::msg::FalconPos, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FalconPos_message_members = {
  ...
  3,  // number of fields
  sizeof(falcon_interfaces::msg::FalconPos),
...
get_message_type_support_handle<falcon_interfaces::msg::FalconPos>()
{
  return &::falcon_interfaces::msg::rosidl_typesupport_introspection_cpp::FalconPos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, falcon_interfaces, msg, FalconPos)() {
  return &::falcon_interfaces::msg::rosidl_typesupport_introspection_cpp::FalconPos_message_type_support_handle;
}
