...
#include "falcon_interfaces/msg/detail/falcon_pos__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const falcon_interfaces::msg::FalconPos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<falcon_interfaces::msg::FalconPos *>(
    untyped_ros_message);
...
{
  return max_serialized_size_FalconPos(full_bounded, 0);
}
...
{
  return &falcon_interfaces::msg::typesupport_fastrtps_cpp::_FalconPos__handle;
}
