...
class ReadFalcon : public rclcpp::Node
{
  public:
    ...
    : Node("read_falcon"), count_(0)
    {
      ...
      if(!dev.open(num_falcons))
        ...
        subscription_ = this->create_subscription<falcon_interfaces::msg::FalconForces>(
        "sendForces", 10, std::bind(&ReadFalcon::force_callback, this, _1));
    ...
    void force_callback(const falcon_interfaces::msg::FalconForces::SharedPtr msg)
    {
      //dev.setFalconKinematic<libnifalcon::FalconKinematicStamper>();
  ...
  private:
    ...
    rclcpp::Subscription<falcon_interfaces::msg::FalconForces>::SharedPtr subscription_;
    size_t count_;
